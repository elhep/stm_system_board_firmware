...
use stm32h7xx_hal::{gpio::ExtiPin,
                    exti::{Event, ExtiExt},
                    device::EXTI, spi::Spi, spi,
                    prelude::_stm32h7xx_hal_spi_HalEnabledSpi};
...
mod app {
    ...
    fn init(c: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        ecp5.write_to_ecp5(42, &[0x00, 0xFF]);      // all outputs

        ecp5.write_to_ecp5(44, &[0x00, 0xFF]);      // all outputs
        ecp5.write_to_ecp5(46, &[0x00, 0xFF]);      // all outputs
        ecp5.write_to_ecp5(48, &[0x00, 0xFF]);      // all outputs
        ecp5.write_to_ecp5(50, &[0x00, 0xFF]);      // all outputs
        ecp5.write_to_ecp5(52, &[0x00, 0xFF]);      // all outputs



        loop{
            ecp5.write_to_ecp5(43, &[0x00, 0x55]);      // all outputs high/low
            ecp5.write_to_ecp5(45, &[0x00, 0x55]);      // all outputs high/low
            ecp5.write_to_ecp5(47, &[0x00, 0x55]);      // all outputs high/low
            ecp5.write_to_ecp5(49, &[0x00, 0x55]);      // all outputs high/low
            ecp5.write_to_ecp5(51, &[0x00, 0x55]);      // all outputs high/low
            ecp5.write_to_ecp5(53, &[0x00, 0x55]);      // all outputs high/low

            ecp5.write_to_ecp5(43, &[0x00, 0xAA]);      // all outputs high/low
            ecp5.write_to_ecp5(45, &[0x00, 0xAA]);      // all outputs high/low
            ecp5.write_to_ecp5(47, &[0x00, 0xAA]);      // all outputs high/low
            ecp5.write_to_ecp5(49, &[0x00, 0xAA]);      // all outputs high/low
            ecp5.write_to_ecp5(51, &[0x00, 0xAA]);      // all outputs high/low
            ecp5.write_to_ecp5(53, &[0x00, 0xAA]);      // all outputs high/low
        }
